...
export const AddressesSection: React.FC = () => {
  ...
  const addressesData = {
    ...
    homecoming: {
      ...
      address: '456 Event Street, New York, NY',
    }
  };
  ...
  return (
    <div className="w-full flex justify-center bg-oldmoney-cream/10">
      <div className="w-full bg-oldmoney-brown text-white px-6 py-16 flex flex-col items-center shadow-md rounded-3xl relative overflow-hidden">
        ...
        >
          <h2 className="font-display font-light text-3xl sm:text-4xl text-oldmoney-taupe leading-none tracking-[0.25em] uppercase">
            ADDRESSES
          </h2>
        ...
        <div className="w-full px-4 sm:px-12 max-w-2xl space-y-8 z-10 relative">
          ...
          >
            ...
            <div className="text-left flex-1 -mt-1.5 pb-2">
              ...
              <p className="font-serif text-[11px] leading-relaxed italic text-oldmoney-taupe/70 font-light mt-1.5 max-w-[210px]">
