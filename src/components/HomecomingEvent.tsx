...
export const HomecomingEvent: React.FC = () => {
  return (
    <div className="py-16 sm:py-24 bg-homecoming-bg relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[80%] h-[80%] bg-gradient-radial from-homecoming-light/20 to-transparent rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          <div className="lg:w-1/2 relative z-10 w-full">
            ...
            >
              <div className="inline-flex items-center gap-4 mb-6">
                <span className="text-homecoming-primary uppercase tracking-[0.4em] sm:tracking-[0.5em] text-[10px] sm:text-[11px] font-bold drop-shadow-sm">
                  Day Three
                </span>
                <div className="w-12 sm:w-20 h-[1px] bg-gradient-to-r from-homecoming-primary/60 to-transparent" />
              </div>

              <h2 className="text-5xl sm:text-6xl lg:text-7xl font-display text-stone-800 mb-8 leading-[1.1] drop-shadow-sm">
                Post-Wedding <span className="italic font-light text-homecoming-primary">Party</span>
              </h2>
              ...
              <div className="relative space-y-10 ml-10 sm:ml-12 border-l-[1.5px] border-homecoming-primary/40 pl-10 sm:pl-12 py-4">
                ...
                <div className="relative group">
                  ...
                  <div>
                    ...
                    <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold">The Crystal Garden, New York</p>
                  </div>
                </div>
          ...
          <div className="lg:w-1/2 w-full relative mt-16 lg:mt-0">
            <motion.div
              ...
              className="relative"
            >
              {/* Elegant dual-arch layout */}
              <div className="absolute -inset-4 sm:-inset-6 border-[2px] border-homecoming-light/40 rounded-[2rem] sm:rounded-[3rem] -z-10 translate-x-4 sm:translate-x-8 translate-y-4 sm:translate-y-8" />
              ...
              <div className="relative aspect-[3/4] sm:aspect-[4/5] rounded-[2rem] sm:rounded-[3rem] overflow-hidden border-[6px] sm:border-[8px] border-white shadow-xl bg-homecoming-bg group flex items-center justify-center">
                <img 
                  src="/WhatsApp Image 2026-06-10 at 01.11.27 (1).webp" 
                  alt="Homecoming" 
