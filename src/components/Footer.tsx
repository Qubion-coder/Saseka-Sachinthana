...
export const Footer: React.FC = () => {
  return (
    <footer aria-label="Footer" className="relative py-20 sm:py-28 px-6 text-center overflow-hidden bg-white">
      ...
      <div className="relative mx-auto max-w-lg">
        ...
        <h2 className="font-serif text-4xl sm:text-5xl md:text-6xl mb-4 text-gray-900">
