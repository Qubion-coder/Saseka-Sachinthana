            ...
            >
              ...
              <div className="relative space-y-10 ml-10 sm:ml-12 border-l-[1.5px] border-church-primary/40 pl-10 sm:pl-12 py-4">
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-2xl sm:text-3xl text-stone-800 mb-1 group-hover:text-church-primary transition-colors duration-500">Wednesday, July 22</h4>
                    <p className="text-stone-500/80 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] font-bold">St. Patrick's Cathedral, New York</p>
                  </div>
                </div>
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-xl sm:text-2xl text-stone-800 mb-1 group-hover:text-church-primary transition-colors duration-500">11:00 AM</h4>
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-xl sm:text-2xl text-stone-800 mb-1 group-hover:text-church-primary transition-colors duration-500">12:30 PM</h4>
                ...
                <div className="relative group">
                  ...
                  <div>
                    <h4 className="font-serif text-xl sm:text-2xl text-stone-800 mb-1 group-hover:text-church-primary transition-colors duration-500">01:00 PM</h4>
          ...
          <div className="lg:w-1/2 w-full relative mt-16 lg:mt-0">
            ...
            >
              ...
              <div className="relative aspect-[3/4] sm:aspect-[4/5] rounded-t-full overflow-hidden border-[6px] sm:border-[8px] border-white shadow-xl bg-church-bg group flex items-center justify-center">
                <img 
                  src="/WhatsApp Image 2026-06-10 at 01.11.22.webp" 
                  alt="Church Function" 
